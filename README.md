...
The trend values are based on [Autoregressive model](https://en.wikipedia.org/wiki/Autoregressive_model) (AR2) learned over the raw data of the last day, similarly to what is done in the [NightScout project](https://nightscout.github.io/).
